...
OPENROUTER_MODEL_DIGEST: str | None = _optional_model("OPENROUTER_MODEL_DIGEST")
OPENROUTER_MODEL_GMAIL_ACTIONS: str | None = _optional_model("OPENROUTER_MODEL_GMAIL_ACTIONS")
...
JARVIS_DAILY_PICTURE_WINDOW_HOURS: int = int(os.getenv("JARVIS_DAILY_PICTURE_WINDOW_HOURS", "12"))
JARVIS_DAILY_PICTURE_LLM_RANKING: bool = _env_bool("JARVIS_DAILY_PICTURE_LLM_RANKING", False)
JARVIS_DAILY_PLANNER_ENABLED: bool = _env_bool("JARVIS_DAILY_PLANNER_ENABLED", True)
JARVIS_DAILY_PLANNER_TIME: str = os.getenv("JARVIS_DAILY_PLANNER_TIME", "08:30").strip()
JARVIS_DAILY_PLANNER_END_TIME: str = os.getenv("JARVIS_DAILY_PLANNER_END_TIME", "18:00").strip()
JARVIS_DAILY_PLANNER_BUFFER_MINUTES: int = int(os.getenv("JARVIS_DAILY_PLANNER_BUFFER_MINUTES", "10"))
TELEGRAM_GMAIL_ACTION_NOTIFICATIONS: bool = _env_bool("TELEGRAM_GMAIL_ACTION_NOTIFICATIONS", True)
...
JARVIS_ANONYMIZATION_CHUNK_CHARS: int = int(os.getenv("JARVIS_ANONYMIZATION_CHUNK_CHARS", "2500"))
